  ...
  <el-dialog :visible.sync="dialog" :title="isAdd ? '新增权限' : '编辑权限'" append-to-body width="500px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item style="margin-bottom: 0px;" label="上级类目">
        <treeselect v-model="form.parentId" :options="permissions" style="width: 360px;" placeholder="选择上级类目" />
      </el-form-item>
    </el-form>
...
<script>
import { add, edit, getPermissionTree } from '@/api/system/permission'
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form = { name: '', alias: '', parentId: 0 }
    },
    getPermissions() {
